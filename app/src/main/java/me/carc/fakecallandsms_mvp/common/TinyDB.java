 ...
 * <p/>
 * U class for share pref save and read
 */
public class TinyDB {
    ...
    private String setupFullPath(String imageName) {
        ...
        File mFolder = new File(DEFAULT_APP_IMAGEDATA_DIRECTORY);
        if (!mFolder.exists()) {

            mFolder = new File(Environment.getExternalStorageDirectory(), DEFAULT_APP_IMAGEDATA_DIRECTORY);
