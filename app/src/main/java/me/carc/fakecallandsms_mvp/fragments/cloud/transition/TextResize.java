...
package me.carc.fakecallandsms_mvp.fragments.cloud.transition;
...
*/
    ...
    private static class SwitchBitmapDrawable extends Drawable {
        ...
        SwitchBitmapDrawable(TextView view, int gravity,
    ...
    static class TextResizeData {
        ...
        TextResizeData(TextView textView) {
