...
import me.carc.fakecallandsms_mvp.fragments.cloud.IntentUtil;
...
public class DetailSharedElementEnterCallback extends SharedElementCallback {
    ...
    private CloudDetailViewBinding currentDetailBinding;
    private CloudPhotoItemBinding currentPhotoBinding;
    ...
    public void onSharedElementStart(List<String> sharedElementNames,
        ...
        targetPadding = new Rect(author.getPaddingLeft(), author.getPaddingTop(), author.getPaddingRight(),
                author.getPaddingBottom());

        if (IntentUtil.hasAll(intent, IntentUtil.TEXT_COLOR, IntentUtil.FONT_SIZE, IntentUtil.PADDING)) {
    ...
    public void onSharedElementEnd(List<String> sharedElementNames,
        ...
        if (targetPadding != null) {
            author.setPadding(targetPadding.left, targetPadding.top, targetPadding.right, targetPadding.bottom);
        }
        if (currentDetailBinding != null) {
            forceSharedElementLayout(currentDetailBinding.author);
        }
    }
    ...
    public void setBinding(@NonNull CloudDetailViewBinding binding) {
        currentDetailBinding = binding;
        currentPhotoBinding = null;
    }

    public void setBinding(@NonNull CloudPhotoItemBinding binding) {
